...
from backtest_unit.backtester.optimization.optimizer import NumbaParameterOptimizer
...
def backtest(
    ...
    optimizer = NumbaParameterOptimizer(backtest, model, model_name)
    ...
    backtest_fig.savefig("numba_test.pdf")
